...
export const asianRestaurantConfig: SiteConfig = {
  ...
  gallery: {
    ...
    images: [
      ...
      {
        src: "https://images.unsplash.com/photo-1614563637806-1d0e645e0940?w=600&q=80",
        alt: "Kom ramen",
        caption: "Tonkotsu Ramen",
      },
      {
        src: "https://images.unsplash.com/photo-1696449241254-11cf7f18ce32?w=600&q=80",
        alt: "Japans restaurant interieur",
        caption: "De Eetkamer",
      },
      {
        src: "https://images.unsplash.com/photo-1566373049939-704ea187ef98?w=600&q=80",
        alt: "Matcha bereiding",
        caption: "Ceremoniële Matcha",
      },
      {
        src: "https://images.unsplash.com/photo-1512132411229-c30391241dd8?w=600&q=80",
        alt: "Food close-up",
        caption: "Precisie & Zorg",
      },
      {
        src: "https://images.unsplash.com/photo-1541491263892-731bc0c6a2ae?w=600&q=80",
        alt: "Japanse whisky highball",
        caption: "Japanse Alcoholische Dranken",
      },
    ],
  },
  testimonials: {
